...
export default function(app, realm) {
    app.post('/api/import_coupons/create', async (req, res) => {
        ...
        const importCoupon = await ImportCoupon.create(realm, supplier, employee, req.body.shipper, req.body.importCouponDetails);
        res.send(importCoupon.json);
    });

    app.get('/api/import_coupons', async (req, res) => {
